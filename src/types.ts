 ...
 * needed by the Matrix Link Language.
 *
 * Kept local so that pure modules (translate, matrix-api, settings) can
 * be imported and tested without pulling in the ad4m:host runtime.
 */
